CREATE VIEW crnt_over_shops_capacity AS
select
...
floor(max(e1.current_over_weight_capacity)) current_over_weight_capacity, -- излишки на складах магазинов в кг за последний полный месяц
floor(max(e1.current_over_piece_capacity)) current_over_piece_capacity -- излишки на складах магазинов в единицах за последний полный месяц
from 
(
select
d1.mnt_balance,
...
0 current_over_weight_capacity,
0 current_over_piece_capacity
from
(
select
b1.mnt_balance,
...
0 max_over_weight_capacity,
0 max_over_piece_capacity,
over_weight_capacity current_over_weight_capacity,
0 current_over_piece_capacity
from
(
select
...
and (date_trunc('month', swg.date_create) = date_trunc('month', current_date - INTERVAL '1  month'))
) b1
group by
b1.mnt_balance,
b1.types_shops_id,
...
0 max_over_piece_capacity,
0 current_over_weight_capacity,
over_piece_capacity current_over_piece_capacity
from
(
select
b1.mnt_balance,
